...
//SQL QUERY
String query = "SELECT * FROM public.student WHERE email = " + "'"+email+"'" + " AND password = " +"'"+password+"'";
...
// Seting Data
 ...
 if(rs.next()){
	 session.setAttribute("st_id",rs.getString(1));
	 out.print("Successfully");
	 session.setAttribute("email",email);
	 response.sendRedirect("http://localhost:8080/ScdProject/Student/StudentHomepage.jsp");
 }
 else{
