    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
				...
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white"><a href="AssignmentView.jsp?<% out.print("code="+resultSet.getString(1));%>" class='text-blue-700 cursor-pointer' type='submit'>View Assignment</a></td>
			</tr>
        </tbody>
        <%
			}
