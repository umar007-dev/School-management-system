...
<h1 class="text-5xl font-extrabold">Fees</h1>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
			<%
				...
				String sql ="SELECT c.course_code ,c.course_name,c.credits From student s Join studies t ON s.user_id = t.student_id And s.user_id = " +s + "Join course c ON c.course_id = t.course_id";
