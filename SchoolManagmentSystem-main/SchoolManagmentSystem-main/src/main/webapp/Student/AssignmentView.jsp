    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
			...
			String studentId = (String)session.getAttribute("st_id");
				 ...
				 String db_password = "";
				 String sql = "SELECT assignment_name,date FROM public.assignment where course_code = " +"'" + s +"'";
				 try{
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white" ><%=count%></td>
