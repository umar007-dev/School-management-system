    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
				...
				<td scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white"><a href="handleRegisterCourse.jsp?cId=<%out.print(resultSet.getString("course_code")+"&sId="+s); %>" class='text-blue-500 hover:text-blue-700 cursor-pointer'>Register</a></td>
			</tr>
        </tbody>
        <%
			}
